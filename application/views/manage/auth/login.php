<html>
  <head>
	...
	<link rel='stylesheet' id='login-css'  href='<?php $this->config->item('adm_template') ?>/css/login.css' type='text/css' media='all' />
	<style type="text/css">
  ...
  <body class="login">
	...
	<form name="loginform" id="loginform" action="<?php echo base_url('/manage/auth/login'); ?>" method="post">
	<p>
		<label>用户名<br />
